...
# repo (freres dans le meme dossier parent). parent est l'equivalent
# pathlib de ".." : on remonte a la racine des projets, puis homelab/.
RACINE = Path(__file__).parent.parent.parent / "homelab"
