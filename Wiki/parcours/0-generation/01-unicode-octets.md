...
scalaire encodable, la chaîne Python, le grapheme cluster et les [[glossaire/octet|octets]] produits
par [[glossaire/utf-8|UTF-8]].

**L'essentiel** — un texte ne possède pas une frontière universelle appelée
« caractère ». Le [[glossaire/point-de-code|point de code]], l'**octet**, l'élément de `str`, le grapheme
cluster visible et le [[glossaire/token|token]] sont des unités différentes.
...
[[glossaire/unicode|Unicode]] attribue des **points de code** dans l'espace `U+0000` à `U+10FFFF`. Un
