...
Rien n'est promu pour l'instant, et
[`src/framework/`](../../src/framework/README.md) reste vide à dessein. La
brique que cette leçon désigne est le client d'appel : une fonction qui accepte
