...
pattern d'intégration des offres (« le LLM ne vit jamais seul »,
FastAPI ~50 % des annonces), et le prérequis des modules suivants : le
serveur MCP l'appellera, Langfuse le tracera.
...
- **Async où ça compte** : les appels Ollama/Qdrant sont de l'I/O —
  ...
  requêtes pendant les attentes réseau (et c'est le module 4 qui
