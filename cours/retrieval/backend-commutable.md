...
([roadmap §10.4](../_archive/roadmap.md)), et l'argument de réversibilité
...
- **Situer les offres managées** (l'objectif « notions cloud » de
  [P.4.1](../_archive/portfolio/p.4-en-suspens/p.4.1-notions-cloud/p.4.1-notions-cloud.md)) :
...
- [Roadmap couche 4](../_archive/roadmap.md) — API OpenAI-compatible, le
  standard de fait
