...
- **La structure d'un threat model lisible** :
  ...
  - **défenses par actif** (ce qui existe déjà, lié) : confinement
    conteneur [3.1.2](../agent/conteneur-moindre-privilege.md),
    hook [3.1.1](../agent/hook-tool-call.md),
    lecture seule MCP [5.1.1](../mcp/serveur-mcp-python.md),
    token HA limité [3.2.1](../agent/outil-home-assistant.md) ;
...
- **Le registre métier** : « moindre privilège », « défense en
  ...
  ([roadmap §10.1](../_archive/roadmap.md), guardrails/RGPD chez GRDF),
  pas le jargon homelab.
- **Le lien souveraineté** : local-first = données qui ne sortent pas
  = argument RGPD ([roadmap §10.3](../_archive/roadmap.md)) — le threat
  model le formalise.
...
pas de détails famille — [P.1.1](../_archive/portfolio/p.1-repos-publics/p.1.1-github-public/p.1.1-github-public.md)).
