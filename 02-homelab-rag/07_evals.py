...
# Le jeu de questions vit a cote de ce script (plus de dependance a
# l'emplacement du repo homelab pour les evals elles-memes).
JEU = Path(__file__).parent / "evals" / "questions.json"
