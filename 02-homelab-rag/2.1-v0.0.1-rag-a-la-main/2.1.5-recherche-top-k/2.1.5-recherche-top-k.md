...
- **Seuil de score** : optionnel, mais un top-k dont le meilleur score
  est bas signale une question hors corpus — matière première du
  « je ne sais pas » de [2.1.6](../2.1.6-rag-complet/2.1.6-rag-complet.md).
