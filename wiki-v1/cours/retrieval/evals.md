...
> [carte du cours](../carte.md) · étape : [`07_evals.py`](../../etapes/retrieval/07_evals.py)

## L'essentiel

« Un projet LLM sans évaluation chiffrée est une démo, pas de
l'ingénierie ». Un jeu de
...
- **Le jeu de questions**
  ([evals/questions.json](../../etapes/retrieval/evals/questions.json)) : 12 entrées
...
- **Trois scores séparés, un par maillon** :
  ...
  - **hallucination** : la réponse affirme-t-elle quelque chose
    ...
    [RAG complet](rag-complet.md)). Ce score-là
...
[07_evals.py](../../etapes/retrieval/07_evals.py) : boucler sur le jeu, exécuter la
...
> Comment évaluez-vous ce système, et à quoi verriez-vous qu'il régresse ?
> *Réussi si* la réponse tient sur un jeu figé et versionné, des scores
> séparés par maillon (retrieval / génération / hallucination) et une
> baseline chiffrée — un score global unique ne dit pas quoi réparer.

## Références

- [Schéma 06_evals_baseline](../_schemas/retrieval/06_evals_baseline.png)
