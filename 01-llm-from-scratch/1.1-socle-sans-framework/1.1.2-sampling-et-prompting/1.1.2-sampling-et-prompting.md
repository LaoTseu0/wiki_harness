...
**Sampling** — l'ordre d'application : logits → temperature → top-k →
top-p → tirage.
...
> flottants selon le batching, architectures MoE. Pour de la
> reproductibilité, il faut figer bien plus que la temperature (seed,
