...
- **Semver en trois chiffres** : MAJEUR.MINEUR.PATCH —
  ...
  **Attention à la double numérotation héritée** : les dossiers du
  ...
  (LlamaIndex) — cf. la PROGRESSION du domaine retrieval. En cas de doute, le
  tag fait foi.
- **Pourquoi sortir tôt** :
  ...
  - un livrable imparfait mais publié bat un chef-d'œuvre en cours :
    seul le premier reçoit des retours.
