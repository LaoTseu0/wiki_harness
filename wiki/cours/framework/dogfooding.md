...
sont les autres domaines de ce repo**. Chaque module consomme les briques
...
- **La boucle de promotion** : script qui marche → besoin ressenti
  ...
  ([clean code production-grade](clean-code.md))
...
semver. Le premier cas réel : le domaine retrieval consommera le client LLM
...
- [Architecture modulaire](architecture-modulaire.md) — les six briques
  que les modules consomment
