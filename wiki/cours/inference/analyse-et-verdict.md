...
Les courbes de la [benchmark documenté vs Ollama](benchmark.md)
...
- **[Verdict Ollama vs vLLM](verdict-ollama-vs-vllm.md)**
      — quand l'un suffit, quand l'autre se justifie

## Synthèse

Le module se referme en boucle complète : déployer
([déploiement](deploiement.md)) → mesurer
([benchmark documenté vs Ollama](benchmark.md)) →
