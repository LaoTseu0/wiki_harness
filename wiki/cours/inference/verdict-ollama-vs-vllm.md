...
- **Quand vLLM se justifie** :
  ...
  - besoin de rendement par euro de GPU (batching continu,
    PagedAttention — [mécanismes vLLM](mecanismes-vllm.md)) ;
...
- **La structure du post/README** (« un README qui tourne ») :
  question → montage ([vLLM sur RTX 2060](vllm-sur-rtx-2060.md))
  → métriques ([métriques : débit et latence](metriques-debit-latence.md))
