...
Refaire **le même mini-agent quatre fois** : à la main (domaine fondamentaux), sur
...
- **Le comparatif, critère par critère** :
  ...
  |---|---|---|---|---|---|
  | **Manuel** ([mini-boucle d'agent](../fondamentaux/boucle-agent.md)) | nous | total | totale (c'est notre code) | élevé | comprendre ; besoins très spécifiques |
...
- Conclure « le manuel est mieux » parce qu'on l'a écrit : le critère
  ...
  mieux que la fierté.
- Apprendre les quatre à fond : le temps y passe et la comparaison n'y
  gagne rien. Un seul se pratique, les trois autres se situent.
